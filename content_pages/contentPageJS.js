function init() {
    let elem = document.getElementById("td1");
    let today = new Date();
    ...
    elem.textContent = "Information nicht verfügbar";
    ...
    navigator.geolocation.getCurrentPosition(function (position) {
        ...
        elem.textContent = dateToTime(sunrise) + " - " + dateToTime(sunset) + " | " + today;
    });
